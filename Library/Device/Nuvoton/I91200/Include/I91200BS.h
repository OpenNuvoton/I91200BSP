...
#ifndef __I91200BS_H__
#define __I91200BS_H__
 ...
 * |        |          |11 = Reserved
 * @var SDADC_T::BSBGLDO
 * Offset: 0x24  Bridge Sense Bandgap and LDO Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |BGEN      |Bandgap enable
 * |        |          |1 = enable
 * |        |          |0 = disable
 * |[1]     |BGFLTCHRG |Bandgap filter charge
 * |        |          |1 = quick charge external capacitor
 * |        |          |0 = high impedance mode (low noise)
 * |[2]     |BGCHOPEN  |BS Bandgap chopper enable
 * |        |          |1 = enable
 * |        |          |0 = disable
 * |[3]     |BGCHOPLFEN|Bandgap low frequency chopper enable
 * |        |          |1 = enable
 * |        |          |0 = disable
 * |[7:4]   |BGTRIM    |Bandgap TRIM
 * |        |          |0000 = bandgap +0
 * |        |          |0001 = bandgap+(1*12)mV
 * |        |          |0010 = bandgap+(2*12)mV
 * |        |          |0011 = bandgap+(3*12)mV
 * |        |          |0100 = bandgap+(4*12)mV
 * |        |          |0101 = bandgap+(5*12)mV
 * |        |          |0110 = bandgap+(6*12)mV
 * |        |          |0111 = bandgap+(7*12)mV
 * |        |          |1000 = bandgap-(8*12)mV
 * |        |          |1001 = bandgap-(7*12)mV
 * |        |          |1010 = bandgap-(6*12)mV
 * |        |          |1011 = bandgap-(5*12)mV
 * |        |          |1100 = bandgap-(4*12)mV
 * |        |          |1101 = bandgap-(3*12)mV
 * |        |          |1110 = bandgap-(2*12)mV
 * |        |          |1111 = bandgap-(1*12)mV
 * |[8]     |BGCHOPPH  |Bandgap chopper phase
 * |        |          |When chopper is off
 * |        |          |0 = chopper switches in default state
 * |        |          |1 = invert chopper switches
 * |[10:9]  |BGLFCHOPFRQSEL|Bandgap Lf chopper frequency selection
 * |        |          |00 = 1024
 * |        |          |01 = 512
 * |        |          |10 = 256
 * |        |          |11 = 128
 * |[12]    |LDOEN     |LDO(Bridge Bias) Enable
 * |        |          |1 = enable
 * |        |          |0 = disable
 * |[13]    |LDODISCHRG|LDO Discharge 
 * |        |          |1 = enable
 * |        |          |0 = disable
 * |[14]    |LDODIVEN  |LDO Voltage Divider Enable
 * |        |          |1 = enable
 * |        |          |0 = disable
 * |[19:16] |LDOSET    |Set LDO output voltage
 * |        |          |0000 = 1.5
 * |        |          |0001 = 1.8
 * |        |          |0010 = 2.1
 * |        |          |0011 = 2.4
 ...
 * |        |          |1001 = 4.2
 * |        |          |1010 = 4.5 
 * |[30:24] |CLKDIV    |Bridge Sense clock divider for 400KHz
 * |        |          |ADC_CLK /(2*400K)
 * |[31]    |CLKEN     |Bridge Sense clock enable for 400KHz, 200KHz and 160Hz
 * |        |          |1 = enable
 * |        |          |0 = disable
 * @var SDADC_T::BSINISTRAMP
 * Offset: 0x28  Bridge Sense Instrumentation Amplifer Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |EN        |Instrumentation Amplifer enable
 * |        |          |1 = enable
 * |        |          |0 = disable
 * |[3:1]   |GAIN      |Instrumentation Amplifer GAIN
 * |        |          |000 = 1
 * |        |          |001 = 2
 * |        |          |010 = 4
 * |        |          |011 = 8
 ...
 * |        |          |110 = 64
 * |        |          |111 = 128
 * |[9:4]   |OFFSETN   |Instrumentation Amplifer offset negetive input opamp
 * |        |          |bit[9] = sign
 * |        |          |bit[8:4] = magnitude
 * |[10]    |OFFSETNEN |Instrumentation Amplifer offset negetvie input opamp enable
 * |        |          |1 = use value of bits [9:4] to change offset of positive input opamp
 * |        |          |0= don¡¦t use bits [9:4]
 * |[11]    |OFFSETPEN |Instrumentation Amplifer offset positive input opamp enable
 * |        |          |1= use value of bits [17:12] to change offset of positive input opamp
 * |        |          |0= don¡¦t use bits [17:12]
 * |[17:12] |OFFSETP   |Instrumentation Amplifer offset positive input opamp
 * |        |          |bit[17] = sign
 * |        |          |bit[16:12] = magnitude
 * |[18]    |CHOPEN    |Instrumentation Amplifer chopper enable
 * |        |          |1 = enable choppers in the three opamps
 * |        |          |0 = disable choppers in the three opamps
 * |[19]    |SYSCHOPEN |Instrumentation Amplifer system chopper enable
 * |        |          |1 = enable system chopper
 * |        |          |0 = disable system chopper
 * |[20]    |OFFSETTRIM|Instrumentation Amplifer offset trim mode  
 * |        |          |1 = enable offset trim mode
 * |        |          |0 = disable offset trim mode
 * |[21]    |CHOPNDIS  |Instrumentation Amplifer chopper negative disable
 * |        |          |When OFFSETTRIM bit is high,
 * |        |          |1 = disable chopper in negative input opamp
 * |        |          |0 = enable chopper in negative input opamp
 * |[22]    |CHOPPDIS  |Instrumentation Amplifer chopper positive disable 
 * |        |          |When OFFSETTRIM bit is high,
 * |        |          |1 = disable chopper in positive input opamp
 * |        |          |0 = enable chopper in positive input opamp
 * |[23]    |CHOPNPH   |Instrumentation Amplifer chopper phase negative input opamp
 * |        |          |When chopper is off or when OFFSETTRIM bit is high,
 * |        |          |0 = chopper switches in negative input opamp in default state
 * |        |          |1 = invert chopper switches in negative input opamp
 * |[24]    |CHOPPPH   |Instrumentation Amplifer chopper phase positive input opamp
 * |        |          |When chopper is off or when OFFSETTRIM bit is high,
 * |        |          |0 = chopper switches in positive input opamp in default state
 * |        |          |1 = enable chopper in positive input opamp
 * |[25]    |CHOPOPH   |Instrumentation Amplifer chopper phase output opamp
 * |        |          |When chopper is off,
 * |        |          |0 = chopper switches in output opamp in default state
 * |        |          |1 = invert chopper switches in output opamp
 * |[27:26] |CHOPF     |Instrumentation Amplifer chopper frequency selection 
 * |        |          |00 = 100kHz
 * |        |          |01 = 200kHz
 * |        |          |10 = 50kHz
 * |        |          |11 = 25kHz
 * |[29:28] |SYSCHOPF  |Instrumentation Amplifer System chopper frequency 
 * |        |          |00 = 40Hz
 * |        |          |01 = 80Hz
 * |        |          |10 = 20Hz
 * |        |          |11 = 10Hz
 * |[30]    |SYSCHOPPH |Instrumentation Amplifer System chopper phase
 * |        |          |When system chopper is off
 * |        |          |0 = system chopper switches in default state
 * |        |          |1 = invert system chopper switches
 */
	...
	__IO uint32_t BSBGLDO;               /*!< [0x0024] Bridge Sense Bandgap and LDO Control Register                    */
	__IO uint32_t BSINISTRAMP;            /*!< [0x0028] Bridge Sense Instrumentation Amplifer Control Register           */
} SDADC_T;
...
#define SDADC_CTL_BSRATE_Pos             (9)                                               /*!< SDADC_T::CTL: RATESEL Position         */
#define SDADC_CTL_BSRATE_Msk             (0x3ul << SDADC_CTL_BSRATE_Pos)                   /*!< SDADC_T::CTL: RATESEL Mask             */
...
#define SDADC_BSBGLDO_BGEN_Pos           (0)                                               /*!< SDADC_T::BSBGLDO: BGEN Position        */
#define SDADC_BSBGLDO_BGEN_Msk           (0x1ul << SDADC_BSBGLDO_BGEN_Pos)                 /*!< SDADC_T::BSBGLDO: BGEN Mask            */

#define SDADC_BSBGLDO_BGFLTCHRG_Pos      (1)                                               /*!< SDADC_T::BSBGLDO: BGFLTCHRG Position   */
#define SDADC_BSBGLDO_BGFLTCHRG_Msk      (0x1ul << SDADC_BSBGLDO_BGFLTCHRG_Pos)            /*!< SDADC_T::BSBGLDO: BGFLTCHRG Mask       */

#define SDADC_BSBGLDO_BGCHOPEN_Pos       (2)                                               /*!< SDADC_T::BSBGLDO: BGCHOPEN Position    */
#define SDADC_BSBGLDO_BGCHOPEN_Msk       (0x1ul << SDADC_BSBGLDO_BGCHOPEN_Pos)             /*!< SDADC_T::BSBGLDO: BGCHOPEN Mask        */

#define SDADC_BSBGLDO_BGCHOPLFEN_Pos     (3)                                               /*!< SDADC_T::BSBGLDO: BGCHOPLFEN Position  */
#define SDADC_BSBGLDO_BGCHOPLFEN_Msk     (0x1ul << SDADC_BSBGLDO_BGCHOPLFEN_Pos)           /*!< SDADC_T::BSBGLDO: BGCHOPLFEN Mask      */

#define SDADC_BSBGLDO_BGTRIM_Pos         (4)                                               /*!< SDADC_T::BSBGLDO: BGTRIM Position      */
#define SDADC_BSBGLDO_BGTRIM_Msk         (0xful << SDADC_BSBGLDO_BGTRIM_Pos)               /*!< SDADC_T::BSBGLDO: BGTRIM Mask          */

#define SDADC_BSBGLDO_BGCHOPPH_Pos       (8)                                               /*!< SDADC_T::BSBGLDO: BGCHOPPH Position    */
#define SDADC_BSBGLDO_BGCHOPPH_Msk       (0x1ul << SDADC_BSBGLDO_BGCHOPPH_Pos)             /*!< SDADC_T::BSBGLDO: BGCHOPPH Mask        */

#define SDADC_BSBGLDO_BGLFCHOPFRQSEL_Pos (9)                                               /*!< SDADC_T::BSBGLDO: BGLFCHOPFRQSEL Position */
#define SDADC_BSBGLDO_BGLFCHOPFRQSEL_Msk (0x3ul << SDADC_BSBGLDO_BGLFCHOPFRQSEL_Pos)       /*!< SDADC_T::BSBGLDO: BGLFCHOPFRQSEL Mask     */

#define SDADC_BSBGLDO_LDOEN_Pos          (12)                                              /*!< SDADC_T::BSBGLDO: LDOEN Position       */
#define SDADC_BSBGLDO_LDOEN_Msk          (0x1ul << SDADC_BSBGLDO_LDOEN_Pos)                /*!< SDADC_T::BSBGLDO: LDOEN Mask           */

#define SDADC_BSBGLDO_LDODISCHRG_Pos     (13)                                              /*!< SDADC_T::BSBGLDO: LDODISCHRG Position  */
#define SDADC_BSBGLDO_LDODISCHRG_Msk     (0x1ul << SDADC_BSBGLDO_LDODISCHRG_Pos)           /*!< SDADC_T::BSBGLDO: LDODISCHRG Mask      */

#define SDADC_BSBGLDO_LDODIVEN_Pos       (14)                                              /*!< SDADC_T::BSBGLDO: LDODIVEN Position    */
#define SDADC_BSBGLDO_LDODIVEN_Msk       (0x1ul << SDADC_BSBGLDO_LDODIVEN_Pos)             /*!< SDADC_T::BSBGLDO: LDODIVEN Mask        */

#define SDADC_BSBGLDO_LDOSET_Pos         (16)                                              /*!< SDADC_T::BSBGLDO: LDOSET Position      */
#define SDADC_BSBGLDO_LDOSET_Msk         (0xful << SDADC_BSBGLDO_LDOSET_Pos)               /*!< SDADC_T::BSBGLDO: LDOSET Mask          */

#define SDADC_BSBGLDO_CLKDIV_Pos         (24)                                              /*!< SDADC_T::BSBGLDO: CLKDIV Position      */
#define SDADC_BSBGLDO_CLKDIV_Msk         (0x7ful << SDADC_BSBGLDO_CLKDIV_Pos)              /*!< SDADC_T::BSBGLDO: CLKDIV Mask          */

#define SDADC_BSBGLDO_CLKEN_Pos          (31)                                              /*!< SDADC_T::BSBGLDO: CLKEN Position       */
#define SDADC_BSBGLDO_CLKEN_Msk          (0x1ul << SDADC_BSBGLDO_CLKEN_Pos)                /*!< SDADC_T::BSBGLDO: CLKEN Mask           */

#define SDADC_BSINISTRAMP_EN_Pos          (0)                                               /*!< SDADC_T::BSINISTRAMP: EN Position       */
#define SDADC_BSINISTRAMP_EN_Msk          (0x1ul << SDADC_BSINISTRAMP_EN_Pos)                /*!< SDADC_T::BSINISTRAMP: EN Mask           */

#define SDADC_BSINISTRAMP_GAIN_Pos        (1)                                               /*!< SDADC_T::BSINISTRAMP: GAIN Position     */
#define SDADC_BSINISTRAMP_GAIN_Msk        (0x7ul << SDADC_BSINISTRAMP_GAIN_Pos)              /*!< SDADC_T::BSINISTRAMP: GAIN Mask         */

#define SDADC_BSINISTRAMP_OFFSETN_Pos     (4)                                               /*!< SDADC_T::BSINISTRAMP: OFFSETN Position  */
#define SDADC_BSINISTRAMP_OFFSETN_Msk     (0x3ful << SDADC_BSINISTRAMP_OFFSETN_Pos)          /*!< SDADC_T::BSINISTRAMP: OFFSETN Mask      */

#define SDADC_BSINISTRAMP_OFFSETNEN_Pos   (10)                                              /*!< SDADC_T::BSINISTRAMP: OFFSETNEN Position */
#define SDADC_BSINISTRAMP_OFFSETNEN_Msk   (0x1ul << SDADC_BSINISTRAMP_OFFSETNEN_Pos)         /*!< SDADC_T::BSINISTRAMP: OFFSETNEN Mask     */

#define SDADC_BSINISTRAMP_OFFSETPEN_Pos   (11)                                              /*!< SDADC_T::BSINISTRAMP: OFFSETPEN Position */
#define SDADC_BSINISTRAMP_OFFSETPEN_Msk   (0x1ul << SDADC_BSINISTRAMP_OFFSETPEN_Pos)         /*!< SDADC_T::BSINISTRAMP: OFFSETPEN Mask     */

#define SDADC_BSINISTRAMP_OFFSETP_Pos     (12)                                              /*!< SDADC_T::BSINISTRAMP: OFFSETP Position  */
#define SDADC_BSINISTRAMP_OFFSETP_Msk     (0x3ful << SDADC_BSINISTRAMP_OFFSETP_Pos)          /*!< SDADC_T::BSINISTRAMP: OFFSETP Mask      */

#define SDADC_BSINISTRAMP_CHOPEN_Pos      (18)                                              /*!< SDADC_T::BSINISTRAMP: CHOPEN Position   */
#define SDADC_BSINISTRAMP_CHOPEN_Msk      (0x1ul << SDADC_BSINISTRAMP_CHOPEN_Pos)            /*!< SDADC_T::BSINISTRAMP: CHOPEN Mask       */

#define SDADC_BSINISTRAMP_SYSCHOPEN_Pos   (19)                                              /*!< SDADC_T::BSINISTRAMP: SYSCHOPEN Position */
#define SDADC_BSINISTRAMP_SYSCHOPEN_Msk   (0x1ul << SDADC_BSINISTRAMP_SYSCHOPEN_Pos)         /*!< SDADC_T::BSINISTRAMP: SYSCHOPEN Mask     */

#define SDADC_BSINISTRAMP_OFFSETTRIM_Pos  (20)                                              /*!< SDADC_T::BSINISTRAMP: OFFSETTRIM Position */
#define SDADC_BSINISTRAMP_OFFSETTRIM_Msk  (0x1ul << SDADC_BSINISTRAMP_OFFSETTRIM_Pos)        /*!< SDADC_T::BSINISTRAMP: OFFSETTRIM Mask     */

#define SDADC_BSINISTRAMP_CHOPNDIS_Pos    (21)                                              /*!< SDADC_T::BSINISTRAMP: CHOPNDIS Position */
#define SDADC_BSINISTRAMP_CHOPNDIS_Msk    (0x1ul << SDADC_BSINISTRAMP_CHOPNDIS_Pos)          /*!< SDADC_T::BSINISTRAMP: CHOPNDIS Mask     */

#define SDADC_BSINISTRAMP_CHOPPDIS_Pos    (22)                                              /*!< SDADC_T::BSINISTRAMP: CHOPPDIS Position */
#define SDADC_BSINISTRAMP_CHOPPDIS_Msk    (0x1ul << SDADC_BSINISTRAMP_CHOPPDIS_Pos)          /*!< SDADC_T::BSINISTRAMP: CHOPPDIS Mask     */

#define SDADC_BSINISTRAMP_CHOPNPH_Pos     (23)                                              /*!< SDADC_T::BSINISTRAMP: CHOPNPH Position  */
#define SDADC_BSINISTRAMP_CHOPNPH_Msk     (0x1ul << SDADC_BSINISTRAMP_CHOPNPH_Pos)           /*!< SDADC_T::BSINISTRAMP: CHOPNPH Mask      */

#define SDADC_BSINISTRAMP_CHOPPPH_Pos     (24)                                              /*!< SDADC_T::BSINISTRAMP: CHOPPPH Position  */
#define SDADC_BSINISTRAMP_CHOPPPH_Msk     (0x1ul << SDADC_BSINISTRAMP_CHOPPPH_Pos)           /*!< SDADC_T::BSINISTRAMP: CHOPPPH Mask      */

#define SDADC_BSINISTRAMP_CHOPOPH_Pos     (25)                                              /*!< SDADC_T::BSINISTRAMP: CHOPOPH Position  */
#define SDADC_BSINISTRAMP_CHOPOPH_Msk     (0x1ul << SDADC_BSINISTRAMP_CHOPOPH_Pos)           /*!< SDADC_T::BSINISTRAMP: CHOPOPH Mask      */

#define SDADC_BSINISTRAMP_CHOPF_Pos       (26)                                              /*!< SDADC_T::BSINISTRAMP: CHOPF Position    */
#define SDADC_BSINISTRAMP_CHOPF_Msk       (0x3ul << SDADC_BSINISTRAMP_CHOPF_Pos)             /*!< SDADC_T::BSINISTRAMP: CHOPF Mask        */

#define SDADC_BSINISTRAMP_SYSCHOPF_Pos    (28)                                              /*!< SDADC_T::BSINISTRAMP: SYSCHOPF Position */
#define SDADC_BSINISTRAMP_SYSCHOPF_Msk    (0x3ul << SDADC_BSINISTRAMP_SYSCHOPF_Pos)          /*!< SDADC_T::BSINISTRAMP: SYSCHOPF Mask     */

#define SDADC_BSINISTRAMP_SYSCHOPPH_Pos   (30)                                              /*!< SDADC_T::BSINISTRAMP: SYSCHOPPH Position */
#define SDADC_BSINISTRAMP_SYSCHOPPH_Msk   (0x1ul << SDADC_BSINISTRAMP_SYSCHOPPH_Pos)         /*!< SDADC_T::BSINISTRAMP: SYSCHOPPH Mask     */
...
#define __I91200BS_SERIES__  (0x912B0000)
#define __CHIP_SERIES__      __I91200BS_SERIES__
