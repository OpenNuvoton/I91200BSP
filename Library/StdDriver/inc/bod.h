...
#define BOD_BODVL_18V        (0x0)      /*!< BOD Voltage Level 1.8V */
#define BOD_BODVL_19V        (0x1)      /*!< BOD Voltage Level 1.9V */
#define BOD_BODVL_20V        (0x2)      /*!< BOD Voltage Level 2.0V */
#define BOD_BODVL_21V        (0x3)      /*!< BOD Voltage Level 2.1V */
#define BOD_BODVL_22V        (0x4)      /*!< BOD Voltage Level 2.2V */
#define BOD_BODVL_24V        (0x5)      /*!< BOD Voltage Level 2.4V */
#define BOD_BODVL_26V        (0x6)      /*!< BOD Voltage Level 2.6V */
#define BOD_BODVL_28V        (0x7)      /*!< BOD Voltage Level 2.8V */
#define BOD_BODVL_30V        (0x8)      /*!< BOD Voltage Level 3.0V */
#define BOD_BODVL_31V        (0x9)      /*!< BOD Voltage Level 3.1V */
#define BOD_BODVL_34V        (0xA)      /*!< BOD Voltage Level 3.4V */
#define BOD_BODVL_36V        (0xB)      /*!< BOD Voltage Level 3.6V */
#define BOD_BODVL_37V        (0xC)      /*!< BOD Voltage Level 3.7V */
#define BOD_BODVL_39V        (0xD)      /*!< BOD Voltage Level 3.9V */
#define BOD_BODVL_42V        (0xE)      /*!< BOD Voltage Level 4.2V */
#define BOD_BODVL_46V        (0xF)      /*!< BOD Voltage Level 4.6V */
...
/**
  * @brief     This function will enable BOD Reset.
  * @param[in] bod The base address of BOD module
  * @return    None
  */
__STATIC_INLINE void BOD_EnableReset(BOD_T *bod)
{
     bod->BODCTL |= BOD_BODCTL_BODRST_Msk;
}

/**
  * @brief     This function will disable BOD Reset.
  * @param[in] bod The base address of BOD module
  * @return    None
  */
__STATIC_INLINE void BOD_DisableReset(BOD_T *bod)
{
     bod->BODCTL &= (~BOD_BODCTL_BODRST_Msk);    
}
