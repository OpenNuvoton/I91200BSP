...
#define SDADC_BSBGLDO_BGTRIM_ZERO      (0)                             /*!<   Bridge Sense Bandgap Trim Zero             */
#define SDADC_BSBGLDO_BGTRIM_12MV      (1<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim 12mv    */
#define SDADC_BSBGLDO_BGTRIM_24MV      (2<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim 24mv    */
#define SDADC_BSBGLDO_BGTRIM_36MV      (3<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim 36mv    */
#define SDADC_BSBGLDO_BGTRIM_48MV      (4<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim 48mv    */
#define SDADC_BSBGLDO_BGTRIM_60MV      (5<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim 60mv    */
#define SDADC_BSBGLDO_BGTRIM_72MV      (6<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim 72mv    */
#define SDADC_BSBGLDO_BGTRIM_84MV      (7<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim 84mv    */
#define SDADC_BSBGLDO_BGTRIM_NEG96MV   (8<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim -96mv   */
#define SDADC_BSBGLDO_BGTRIM_NEG84MV   (9<<SDADC_BSBGLDO_BGTRIM_Pos)   /*!<   Bridge Sense Bandgap Trim -84mv   */
#define SDADC_BSBGLDO_BGTRIM_NEG72MV   (10<<SDADC_BSBGLDO_BGTRIM_Pos)  /*!<   Bridge Sense Bandgap Trim -72mv   */
#define SDADC_BSBGLDO_BGTRIM_NEG60MV   (11<<SDADC_BSBGLDO_BGTRIM_Pos)  /*!<   Bridge Sense Bandgap Trim 96mv    */
#define SDADC_BSBGLDO_BGTRIM_NEG48MV   (12<<SDADC_BSBGLDO_BGTRIM_Pos)  /*!<   Bridge Sense Bandgap Trim 96mv    */
#define SDADC_BSBGLDO_BGTRIM_NEG36MV   (13<<SDADC_BSBGLDO_BGTRIM_Pos)  /*!<   Bridge Sense Bandgap Trim 96mv    */
#define SDADC_BSBGLDO_BGTRIM_NEG24MV   (14<<SDADC_BSBGLDO_BGTRIM_Pos)  /*!<   Bridge Sense Bandgap Trim 96mv    */
#define SDADC_BSBGLDO_BGTRIM_NEG12MV   (15<<SDADC_BSBGLDO_BGTRIM_Pos)  /*!<   Bridge Sense Bandgap Trim 96mv    */

#define SDADC_BSBGLDO_BGFLTCHRG_QUICK      (1<<SDADC_BSBGLDO_BGFLTCHRG_Pos)   /*!<   Bridge Sense Bandgap filter charge - quick charge external capacitor */
#define SDADC_BSBGLDO_BGFLTCHRG_LOWNOISE   (0)                                /*!<   Bridge Sense Bandgap filter charge - high impedance mode(low noise) */
...
/**
  * @brief      Set BS Bandgap Trim Value.
  * @param      sdadc The base address of SDADC module
  * @param      u32Value Bandgap's trim value.
  * @return     None
  */
#define SDADC_SET_BS_BANDGAPTRIM(sdadc,u32Value)   (sdadc->BSBGLDO = (sdadc->BSBGLDO&~SDADC_BSBGLDO_BGTRIM_Msk)|u32Value)

/**
  * @brief      Enable BS Bandgap
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_ENABLE_BS_BANDGAP(sdadc)   (sdadc->BSBGLDO |= SDADC_BSBGLDO_BGEN_Msk)

/**
  * @brief      Disable BS Bandgap
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_DISABLE_BS_BANDGAP(sdadc)   (sdadc->BSBGLDO &= ~SDADC_BSBGLDO_BGEN_Msk)

/**
  * @brief      Enable BS Bandgap Low Frequency Chopper
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_ENABLE_BS_LOWFREQCHOPPER(sdadc)   (sdadc->BSBGLDO |= SDADC_BSBGLDO_BGCHOPLFEN_Msk)

/**
  * @brief      Disable BS Bandgap Low Frequency Chopper
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_DISABLE_BS_LOWFREQCHOPPER(sdadc)   (sdadc->BSBGLDO &= ~SDADC_BSBGLDO_BGCHOPLFEN_Msk)

/**
  * @brief      Set BS Bandgap Filter Charge
  * @param      sdadc The base address of SDADC module
  * @param      u32Type The type of filter charge mode.
  *             - \ref SDADC_BSBGLDO_BGCHOPLFEN_QUICK
  *             - \ref SDADC_BSBGLDO_BGCHOPLFEN_LOWNOISE  
  * @return     None
  */
#define SDADC_SET_BS_FILTERCHARGE(sdadc,u32Type)   (sdadc->BSBGLDO = (sdadc->BSBGLDO&~SDADC_BSBGLDO_BGFLTCHRG_Msk)|u32Type)
...
/**
  ...
  * @return     None
  */
#define SDADC_ENABLE_BS_LDOVOLDIV(sdadc)   (sdadc->BSBGLDO |= SDADC_BSBGLDO_LDODIVEN_Msk)
...
/**
  ...
  * @return     None
  */
#define SDADC_DISABLE_BS_LDOVOLDIV(sdadc)   (sdadc->BSBGLDO &= ~SDADC_BSBGLDO_LDODIVEN_Msk)

/**
  * @brief      Enable BS Instrumentation Amplifer chopper
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_ENABLE_BS_INSAMPCHOP(sdadc)   (sdadc->BSINISTRAMP |= SDADC_BSINISTRAMP_CHOPEN_Msk)

/**
  * @brief      Disable BS Instrumentation Amplifer chopper
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_DISABLE_BS_INSAMPCHOP(sdadc)   (sdadc->BSINISTRAMP &= ~SDADC_BSINISTRAMP_CHOPEN_Msk)

/**
  * @brief      Enable BS Instrumentation Amplifer.
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_ENABLE_BS_INSAMP(sdadc)   (sdadc->BSINISTRAMP |= SDADC_BSINISTRAMP_EN_Msk)

/**
  * @brief      Disable BS Instrumentation Amplifer.
  * @param      sdadc The base address of SDADC module
  * @return     None
  */
#define SDADC_DISABLE_BS_INSAMP(sdadc)   (sdadc->BSINISTRAMP &= ~SDADC_BSINISTRAMP_EN_Msk)
