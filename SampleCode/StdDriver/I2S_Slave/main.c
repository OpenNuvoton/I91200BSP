...
BOOL I2S_Slave_Setup(void);
void I2S_Slave_Configuration(void);
void I2S_Slave_Start(void);

// Show message.
void Show_DemoLabel(void);
void Show_SlaveSetup(BOOL);
...
{	
	...
	// Configure VI2S_Slave
	I2S_Slave_Configuration();
...
BOOL I2S_Slave_Setup()
{
	// Open I2S0 as Slave; sampling rate 16000; reset
	if(VI2S_Open(0, 0, 16000, E_VI2S_CLK_HIRC, TRUE))
	{
...
void I2S_Slave_Configuration(void)
{
	VI2S_Config(0,VI2S_CFG_SLAVE|VI2S_CFG_STEREO|VI2S_CFG_WORD16|VI2S_CFG_FORMATI2S|VI2S_CFG_TXTH4|VI2S_CFG_RXTH4);
}
...
{
	printf("(1) Setup I2S Slave function.\r\n");
...
void Show_Start()
{
	printf("(2) Please make sure GPA0 & GPA1 & GPA2 & GPA3 connect to I2S_Master.\r\n");	
